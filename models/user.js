...
class User {
  ...
  // Allow user to create job application
  ...
  static async applyForJob(username, jobId) {
    ...
    if (!userRes.rows[0]) throw new NotFoundError(`User not found: ${username}`);
    if (!jobRes.rows[0]) throw new NotFoundError(`Job not found: ${jobId}`);
