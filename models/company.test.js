...
describe("findAll", function () {
  ...
  test("works: with name, minEmployees, and maxEmployees filters", async function () {
  ...
  test("works: with invalid filter values", async function () {
    let companies = await Company.findAll({ name: "Invalid", minEmployees: 100, maxEmployees: 200 });
    expect(companies).toEqual([]);
  });
});
